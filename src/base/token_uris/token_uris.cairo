            ...
            return format!(
                ...
                encoded
                    .encode_packed(
                        encoded_empty(
                            format!(
                                "{{\"local_name\":\"#@{}\",\"image\":\"data:image/svg+xml;base64,{}\",\"attributes\":[{{\"display_type\":\"number\",\"trait_type\":\"ID\",\"value\":\"{}\"}},{{\"trait_type\":\"NAMESPACE\",\"value\":\"{}\"}},{{\"trait_type\":\"LENGTH\",\"value\":\"{}\"}}]}}",
                                local_name,
                                encoded_inner.encode_packed(profile_svg_example),
                                token_id,
                                namespace,
                                encoded_inner.encode_packed(localName),
                            )
                        )
                    )
            );
